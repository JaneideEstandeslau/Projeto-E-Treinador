...
public class TelaListrCadastrarTreino extends ClasseParaCriarJanela implements ActionListener{
	...
	public TelaListrCadastrarTreino(){
	...
	public void adicionarButton(){
		...
		add(botaoPesquisar);
		botaoPesquisar.addActionListener(new ObservadorPCadastrarTreinos(this));
		
		//cria bot�o concluir
		JButton botaoConcluir = new JButton("Cadastrar");
		botaoConcluir.setFont(fonte);
		botaoConcluir.setBounds(350, 310, 120, 33);
		add(botaoConcluir);
		
		//define o ouvinte para o bot�o concluir
		botaoConcluir.addActionListener(new  ObservadorBTCadastrarTreinos(this));
