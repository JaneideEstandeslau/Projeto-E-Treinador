...
public class TelaExcluirAluno extends ClasseParaCriarJanela implements ActionListener{
	...
	public void adicionarButton(){
		...
		add(botaoPesquisar);
		botaoPesquisar.addActionListener(new ObservadorPExcluirAluno(this));
		
		//cria bot�o concluir
		JButton botaoConcluir = new JButton("Excluir");
		botaoConcluir.setFont(fonte);
		botaoConcluir.setBounds(350, 310, 120, 33);
		add(botaoConcluir);
		
		//define o ouvinte para o bot�o concluir
		botaoConcluir.addActionListener(new ObservadorExcluirAluno(this));
