...
import aluno.CriarButton;
import aluno.CriarTabela;
import aluno.ObeservadorPEdicaoTreino;
import aluno.OuvinteDoBotaoConcluir;
import aluno.OuvinteEditarTreino;
import treinos.Academia;
import treinos.Aluno;
import treinos.Persistencia;


public class GeraRelatorio extends ClasseParaCriarJanela implements ActionListener{
...
//		this.adicionarLabel();
	...
	public void adicionarButton(){
		...
		add(botaoPesquisar);
		botaoPesquisar.addActionListener(new ObservadorButtonPRelatorio(this));
...
////		botaoConcluir.addActionListener(new OuvinteDoBotaoConcluir(this));
		...
		//editar
		JButton botaoEdittar = new JButton("Gerar");
		botaoEdittar.setFont(fonte);
		botaoEdittar.setBounds(350, 310, 120, 33);
		add(botaoEdittar);
		botaoEdittar.addActionListener(new OuvinteBotaoGeraRelatorio(this));
		
		JButton botaoaCancelar = new JButton("Cancelar");
		botaoaCancelar.setBounds(230, 310, 110, 33);
